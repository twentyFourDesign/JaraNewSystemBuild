...
const ManageBooking = () => {
  ...
  const { setPreviousCost, setPreviousPaymentStatus } =
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-gray-100 gap-5">
      ...
      {bookingData && (
        <div className="mt-12 border-2 border-[#7EC4F6] bg-[#E6F5FF] rounded-md py-4">
          <table className="table-auto w-full text-left ">
            <tr className="border-b-2 border-[#7EC4F6]">
              <th className="text-lg font-bold pl-4 pb-2 ">Booking Details</th>
            </tr>
            ...
            <tbody>
              ...
              {bookingData?.bookingDetails?.selectedRooms && (
                <tr>
                  ...
                  <td className="px-4 py-2 font-bold">
                    {bookingData?.bookingDetails?.selectedRooms.map((room) => (
                      <>
