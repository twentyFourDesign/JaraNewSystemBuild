    ...
    return (
        ...
        <div className=' bg-[#eff6ff] font-robotoFont'>
            ...
            <div className='sm:flex justify-center items-center gap-x-4 mb-4 ml-2 mr-2'>
                <button className='w-[100%] sm:w-[13rem] h-[2.4rem] bg-black text-white rounded-md cursor-pointer font-robotoFont'>Make an other booking</button>
                <button className='w-[100%] sm:mt-0 mt-3 sm:w-[13rem] h-[2.4rem] bg-black text-white rounded-md cursor-pointer font-robotoFont'>Go to Website</button>
            </div>
