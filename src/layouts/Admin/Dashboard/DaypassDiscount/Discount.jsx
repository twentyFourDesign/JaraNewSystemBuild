...
import { DaypassDiscountsRow } from '../../../../constants/tableData'
  ...
  return (
    <div className='font-robotoFont w-[100%] overflow-x-auto'>
      ...
      <div className='w-[100%] bg-white h-[6rem] flex justify-between items-center p-5 border-b-2 border-solid border-[#e6e7e9]'>
        <h1 className='text-2xl font-medium'>Day Pass Discount 💵</h1>
        {
      ...
      <div className='p-5'>
        ...
        <div className='mb-4 block md:flex justify-between items-start'>
          ...
          <Button onClickFunc={()=>setshowPopup(true)} buttonTitle={"Create New"} className={"w-[11rem] h-[2.5rem] font-bold rounded-md text-white font-cursive bg-blue-800"}/>
        </div>
        <div>
          <Table tr={DaypassDiscountsRow} data={data} setData={setData}/>
        </div>
      </div>
