      ...
      <div className="p-5">
        <div className="mb-4 block md:flex justify-between items-start">
          ...
          <div className="flex gap-x-2 items-center md:mb-0 mb-3">
            <Button
              onClickFunc={() => setType("overnight")}
              buttonTitle={"Overnight"}
              className={`w-[6rem] h-[2rem] text-sm font-bold rounded-md  font-cursive ${
                Type === "overnight"
            ...
            />
            <Button
              onClickFunc={() => setType("daypass")}
              buttonTitle={"Day pass"}
              className={`w-[6rem] h-[2rem] text-sm font-bold rounded-md font-cursive ${
                Type === "daypass"
                  ? "bg-blue-800 border-none text-white"
                  : "border-2 border-blue-800 text-black"
