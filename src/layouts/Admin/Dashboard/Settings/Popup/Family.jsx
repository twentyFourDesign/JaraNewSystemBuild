...
const Family = ({setShowPopups,showPopups}) => {

    const [data, setData] = useState({id:"",type:"family",price:""})

    const getData = async ()=>{
        let response = await axios.get(`${baseUrl}/rooms/get/family`)
  ...
  return (
    <div className='bg-white p-3 w-[80%] sm:w-[60%] md:w-[30%] rounded-md'>
        ...
        <div className='flex justify-between items-center w-[100%]'>
            <p>Family Room</p>
            <ImCross className='cursor-pointer' onClick={()=>{setShowPopups({...showPopups,family:false})}}/>
        </div>
