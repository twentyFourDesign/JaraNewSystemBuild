...
const Villa = ({setShowPopups,showPopups}) => {

    const [data, setData] = useState({id:"",type:"villa",price:""})

    const getData = async ()=>{
        let response = await axios.get(`${baseUrl}/rooms/get/villa`)
  ...
  return (
    <div className='bg-white p-3 w-[80%] sm:w-[60%] md:w-[30%] rounded-md'>
        ...
        <div className='flex justify-between items-center w-[100%]'>
            <p>Villa Room</p>
            <ImCross className='cursor-pointer' onClick={()=>{setShowPopups({...showPopups,villa:false})}}/>
        </div>
