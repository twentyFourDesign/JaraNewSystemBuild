...
const Studio = ({setShowPopups,showPopups}) => {

    const [data, setData] = useState({id:"",type:"studio",price:""})

    const getData = async ()=>{
        let response = await axios.get(`${baseUrl}/rooms/get/studio`)
  ...
  return (
    <div className='bg-white p-3 w-[80%] sm:w-[60%] md:w-[30%] rounded-md'>
        ...
        <div className='flex justify-between items-center w-[100%]'>
            <p>Studio Room</p>
            <ImCross className='cursor-pointer' onClick={()=>{setShowPopups({...showPopups,studio:false})}}/>
        </div>
