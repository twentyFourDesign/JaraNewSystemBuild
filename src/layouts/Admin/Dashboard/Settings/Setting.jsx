    ...
    <div className="font-robotoFont w-[100%] overflow-x-auto">
      ...
      <div className="flex justify-center items-center flex-1 w-full h-[80vh]">
        <div className="bg-white p-4 w-[100%] lg:w-[70%] ml-5 mr-5 rounded-md flex justify-center md:justify-start items-center gap-2 flex-wrap">
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, villa: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Villa Room</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, loft: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>The Loft</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, family: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Family Room</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, studio: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Studio Room</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, cake: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Cakes</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, daypass: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Daypass Opt</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, personalize: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, riding: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Riding</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, drink: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Premium Drink</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, holiday: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Holiday Dates</p>
          </div>
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, blocked: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
          ...
          <div
            onClick={() => setShowPopups({ ...showPopups, disable: true })}
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Disable Extras</p>
          </div>
          ...
          <div
            onClick={() =>
              setShowPopups({ ...showPopups, unforgettableExp: true })
            }
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Unforgettable Exp</p>
          </div>
          <div
            onClick={() =>
              setShowPopups({ ...showPopups, roomDecoration: true })
            }
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Room Decoration</p>
          ...
          <div
            onClick={() =>
              setShowPopups({ ...showPopups, domesticStaff: true })
            }
            className="bg-[#eff6ff]  h-[4rem] min-w-[8rem] flex justify-center items-center rounded-md cursor-pointer"
          >
            <p>Domestic Staff</p>
